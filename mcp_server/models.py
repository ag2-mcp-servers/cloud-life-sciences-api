...
class Action(BaseModel):
    ...
    blockExternalNetwork: Optional[bool] = Field(
        None, description='Prevents the container from accessing the external network.'
    )
    ...
    disableImagePrefetch: Optional[bool] = Field(
        None,
    ...
    disableStandardErrorCapture: Optional[bool] = Field(
        None,
    ...
    enableFuse: Optional[bool] = Field(
        None,
    ...
    publishExposedPorts: Optional[bool] = Field(
        None,
    ...
    runInBackground: Optional[bool] = Field(
        None,
...
class Event(BaseModel):
    containerKilled: Optional[ContainerKilledEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.ContainerKilledEvent.'
    )
    containerStarted: Optional[ContainerStartedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.ContainerStartedEvent.'
    )
    containerStopped: Optional[ContainerStoppedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.ContainerStoppedEvent.'
    )
    delayed: Optional[DelayedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.DelayedEvent.'
    )
    ...
    failed: Optional[FailedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.FailedEvent.'
    )
    pullStarted: Optional[PullStartedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.PullStartedEvent.'
    )
    pullStopped: Optional[PullStoppedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.PullStoppedEvent.'
    )
    timestamp: Optional[str] = Field(
        None, description='The time at which the event occurred.'
    )
    unexpectedExitStatus: Optional[UnexpectedExitStatusEvent] = Field(
        None,
        description='See google.cloud.lifesciences.v2beta.UnexpectedExitStatusEvent.',
    )
    workerAssigned: Optional[WorkerAssignedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.WorkerAssignedEvent.'
    )
    workerReleased: Optional[WorkerReleasedEvent] = Field(
        None, description='See google.cloud.lifesciences.v2beta.WorkerReleasedEvent.'
    )
